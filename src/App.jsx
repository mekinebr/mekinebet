              ...
              <section key={item.id || index} className="card">
                ...
                <div className="flowCard">
                  ...
                  <div className="flowWrap">
                    ...
                    <div className="nowLine" style={{ left: `${(currentMinute / 90) * 100}%` }}><b>{currentMinute}'</b></div>
                    {events.map((ev, i) => (
                      <React.Fragment key={i}>
                        ...
                        />
                        {ev.icon && <span className={`flowIcon ${ev.team}`} style={{ left: `${(ev.m / 90) * 100}%` }}>{ev.icon}</span>}
                      </React.Fragment>
                    ))}
                  </div>
