                ...
                <div className="timelineContainer">
                  ...
                  <div className="timelineEvents">
                    <div className="eventItem">
                      ...
                      <span className="eventText">Gol</span>
                    </div>
                    <div className="eventItem">
                      <span className="time">28'</span>
                      <span className="eventIcon">🟨</span>
                      <span className="eventText">Cartão Amarelo</span>
                    </div>
                    <div className="eventItem">
                  ...
                  <div className="timelineTeam right">
...
/* CRONOLOGIA SOFASCORE */
.timeline { margin: 10px 0; background: #071a10; border: 1px solid #0f7a3e; border-radius: 10px; padding: 12px; }
.timelineTitle { text-align: center; color: #00ff70; font-size: 11px; font-weight: 700; margin-bottom: 8px; letter-spacing: 0.5px; }
.timelineContainer { display: flex; align-items: center; gap: 10px; }
.teamSide { width: 38px; flex-shrink: 0; }
.teamSide img { width: 38px; height: 38px; border-radius: 50%; border: 2px solid #1e3a2f; }
.events { flex: 1; display: flex; gap: 8px; overflow-x: auto; padding: 4px 0; }
.eventItem { display: flex; flex-direction: column; align-items: center; gap: 2px; font-size: 10px; min-width: 48px; }
.time { font-size: 9px; color: #94a3b8; font-weight: 600; }
.eventIcon { font-size: 16px; }
.eventText { font-size: 9px; color: #cbd5e1; white-space: nowrap; }
